...
{
  public  class MySqlDataUtilites
    {
        ...
        public DataSet ExecuteDataSet(string commandText, Hashtable htParameters)
        {
            ...
            var objSqlCommand = new MySqlCommand
            {
                Connection = objMySqlConn,
                CommandType = CommandType.StoredProcedure,
                CommandText = commandText,
        ...
        public int ExecuteScalar(string commandText, string commandType)
        {
            ...
            int nRValue = 0;
            MySqlTransaction objSqlTransaction = null;
            MySqlConnection objMySqlConn = GetSqlConnection();
            if (objMySqlConn != null)
            {
                ...
                try
                {
                    var objMySqlCmd = new MySqlCommand
                    {
                        Connection = objMySqlConn,
        ...
        public int ExecuteNonQuery(string commandText, Hashtable htParameters, string retunParameter)
        {
            ...
            try
            {
                ...
                objSqlCommand.Parameters.AddWithValue(retunParameter, SqlDbType.Int).Direction = ParameterDirection.ReturnValue;
                objMySqlConn.Open();
        ...
        ///// <param name="htParameters"></param>
        ///// <returns>Returns Integer</returns>
        //public MySqlDataAdapter ExecuteReader(string commandText, Hashtable htParameters)
        //{
        //    MySqlTransaction objSqlTransaction = null;
        //    MySqlConnection objMySqlConn = GetSqlConnection();
        ...
        //        objMySqlConn.Open();
        //        reader1 = objSqlCommand.ExecuteReader();
        //    }
        //    catch (Exception)
        //    {
        //        if (objSqlTransaction != null)
